...
The solution to min cost climbing stairs problem with $\text{cost} = [1,5,2,4,3]$.
...
The space optimized solution to min cost climbing stairs problem with $\text{cost} = [1,5,2,4,3]$.
...
<MultipleChoice
    ...
    original climbing stairs problem.'>
