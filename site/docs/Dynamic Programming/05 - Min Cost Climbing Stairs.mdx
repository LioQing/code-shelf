...
<VideoPlayer
    src={require('/video/dp/dp_05_01.mp4').default}
    text='The solution to min cost climbing stairs problem with cost = [1,5,2,4,3].'
/> 
...
<VideoPlayer
    src={require('/video/dp/dp_05_02.mp4').default}
    text='The space optimized solution to min cost climbing stairs problem with cost = [1,5,2,4,3].'
/> 
