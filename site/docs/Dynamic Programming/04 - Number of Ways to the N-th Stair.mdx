---
description: Count the number of ways to reach the n-th stair using dynamic programming.
---

import VideoPlayer from '@site/src/components/utils/VideoPlayer';

<head>
  <title>Number of Ways to the N-th Stair | Dynamic Programming</title>
</head>
...
```pseudocode title="Number of Ways to the N-th Stair"
function waysToNthStair(n: int) -> int:
...
The solution to the number of ways to the n-th stair problem with $n = 5$.
...
```pseudocode title="Number of Ways to the N-th Stair - Space Optimized"
function waysToNthStair(n: int) -> int:
...
The space optimized solution to the number of ways to the n-th stair problem with $n = 5$.
...
```python title="Number of Ways to the N-th Stair"
def waysToNthStair(n):
    # exceptional case for n = 1
    if n == 1:
        return 1
...
```python title="Number of Ways to the N-th Stair - Space Optimized"
def waysToNthStair(n):
    # initialize base cases
    prev = 1
    curr = 2
...
```cpp title="Number of Ways to the N-th Stair"
#include <iostream>
#include <vector>
...
```cpp title="Number of Ways to the N-th Stair - Space Optimized"
#include <iostream>
...
```rust title="Number of Ways to the N-th Stair"
fn ways_to_nth_stair(n: i32) -> i32 {
    // exceptional case for n = 1
    if n == 1 {
        return 1;
    }
...
```rust title="Number of Ways to the N-th Stair - Space Optimized"
fn ways_to_nth_stair(n: i32) -> i32 {
    // initialize base cases
    let mut prev = 1;
    let mut curr = 2;
...
LeetCode - Climbing Stairs: [https://leetcode.com/problems/climbing-stairs/](https://leetcode.com/problems/climbing-stairs/)