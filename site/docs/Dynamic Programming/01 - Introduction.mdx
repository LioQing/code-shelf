...
<VideoPlayer
    src={require('/video/dp/dp_01_01.mp4').default}
    text='Optimal substructure shown in f(4). Wrong value for f(1) leading to wrong value for f(4).'
/> 
...
<VideoPlayer
    src={require('/video/dp/dp_01_02.mp4').default}
    text='Overlapping subproblems shown in f(5). Same subproblems are colored in the same color. Many subproblems are repeated.'
/>
